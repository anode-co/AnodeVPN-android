package co.anode.anodium.connection.manageWalletConfigs;
...
public class WalletConfigsManager {
    ...
    private WalletConfigsManager() {
        ...
        try {
            decrypted = "";//TODO:PrefsUtil.getEncryptedPrefs().getString(PrefsUtil.WALLET_CONFIGS, "");
        } catch ( Exception e) {
            e.printStackTrace();
        }
    ...
    public WalletConfig getCurrentWalletConfig() {
        WalletConfig config = getWalletConfigById("1");
    ...
    public void apply() throws GeneralSecurityException, IOException {
        ...
        //TODO:PrefsUtil.editEncryptedPrefs().putString(PrefsUtil.WALLET_CONFIGS, jsonString).commit();
    }
}
