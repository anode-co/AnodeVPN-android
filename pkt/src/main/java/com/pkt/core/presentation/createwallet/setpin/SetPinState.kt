...
sealed class SetPinNavigation : InternalNavigation {
    ...
    data class ToRecoverWallet(private val password: String, private val pin: String, private val name: String) : SetPinNavigation() {
        override val navDirections: NavDirections
            get() = SetPinFragmentDirections.toRecoverWallet(password, pin, name)
    }
}
