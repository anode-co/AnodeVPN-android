...
sealed class AppNavigation : UiNavigation {
    ...
    data class OpenSendConfirm(val fromaddress: String, val toaddress:String, val amount: Double, val maxAmount: Boolean, val premiumVpn: Boolean, val isVote: Boolean, val isVoteCandidate: Boolean) : AppNavigation()
